...
class TestAdminAccController {
    ...
    public void setup() {
        ...
        mockMvc = MockMvcBuilders.standaloneSetup(adminAccController).build();
    }
...
//        verify(operatorRepository).updateWithEmail1("John Doe", "john@example.com", "test@example.com");
    }
